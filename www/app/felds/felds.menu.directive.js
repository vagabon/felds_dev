...
define([], function () {
  var moduleName = 'felds.menu.directive';
          ...
          compile: function (element, attr) {
            ...
            function prelink($scope, $element, $attr, sideMenuCtrl) {
              ...
              function onContentTap(gestureEvt) {
                // GOnzague : if (sideMenuCtrl.getOpenAmount() !== 0) {
              ...
              var content = {
                ...
                addMenuHide: function() {
                  var menuContentHide = document.getElementById("menu-content-hide");
                  if (menuContentHide == undefined) {
                    var menuContent = document.getElementsByClassName("menu-content");
                    menuContentHide = document.createElement('div');
                    menuContentHide.setAttribute('id', "menu-content-hide");
                    menuContentHide.setAttribute('style', 'background: black; z-index: 10; position: absolute; width: 100%; height: 100%; opacity: 0.40; top: 44px; visibility: hidden;');
                    menuContent[0].appendChild(menuContentHide);
                  }
                  return menuContentHide;
                },
                setTranslateX: ionic.animationFrameThrottle(function (amount, isMenu) {
                  // GONZAGUE
                  // var menuContent = document.getElementsByClassName("menu-content");
                  var xTransform = content.offsetX + amount - parseInt($element[0].style["width"]);

                  var menuContentHide = content.addMenuHide();
                  if (xTransform + parseInt($element[0].style["width"]) == 0) {
                    menuContentHide.style.visibility = "hidden";
                  }

                  $element[0].style["margin-left"] = 0;
    ...
    .controller('$ionicSideMenus', [
      ...
      function($scope, $attrs, $ionicSideMenuDelegate, $ionicPlatform, $ionicBody, $ionicHistory) {
        ...
        self.getOpenAmount = function() {
          // GONZAGUE
          var menuContentHide = self.content.addMenuHide();
          if (self.content.getTranslateX() > 0) {
            menuContentHide.style.visibility = "visible";
          } else {
            menuContentHide.style.visibility = "hidden";
          }
          var amount = self.content && self.content.getTranslateX() || 0;
          menuContentHide.style.opacity = 0.30 + ((amount - parseInt(self.content.element.style["width"])) / 1000);
          return amount;
        };
        ...
        self.isDraggableTarget = function(e) {
          ...
          // GOnzague self.content.element.offsetWidth > document.width
          var dragIsWithinBounds = !shouldOnlyAllowEdgeDrag ||
            startX <= self.edgeThreshold ||
            startX >= document.width - self.edgeThreshold;
